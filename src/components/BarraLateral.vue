<template>
    <aside
        class="tw-bg-[#0d3b66] tw-fixed tw-left-0 tw-top-0 tw-h-screen tw-w-64 tw-flex tw-flex-col tw-items-center tw-justify-start tw-p-6 tw-z-50 dark:tw-bg-[#333] dark:tw-text-white">
        <h1>
